...
<script>
    ...
    <section class="regcontainer">
        <h2>book yor hall now</h2>
        <div class="regcardcontainer">
            <div class="reghallimg">
                <!-- img div -->
            </div>
            <div class="regcontent">
                <h3>Reservation</h3>
                <form class="regform" name="myform" onsubmit="return valid()" action="reghdtl.php" method="post">
                    <div class="formrow">
                    ...
                    <div class="formrow">
                        ...
                        <input type="submit" value="BOOK HALL" id="submit">
